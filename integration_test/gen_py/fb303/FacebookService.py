...
class getName_result(object):
  ...
  thrift_spec = (
    (0, TType.UTF8, 'success', None, None, ), # 0
  )
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.UTF8, 0)
...
class getCounters_result(object):
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.UTF8,None,TType.I64,None), None, ), # 0
  )
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      oprot.writeMapBegin(TType.UTF8, TType.I64, len(self.success))
...
class getCounter_args(object):
  ...
  def write(self, oprot):
    ...
    if self.key is not None:
      oprot.writeFieldBegin('key', TType.UTF8, 1)
...
class setOption_args(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.UTF8, 'key', None, None, ), # 1
    (2, TType.UTF8, 'value', None, None, ), # 2
  )
  ...
  def write(self, oprot):
    ...
    if self.value is not None:
      oprot.writeFieldBegin('value', TType.UTF8, 2)
...
class getOptions_result(object):
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.UTF8,None,TType.UTF8,None), None, ), # 0
  )
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.MAP, 0)
      oprot.writeMapBegin(TType.UTF8, TType.UTF8, len(self.success))
